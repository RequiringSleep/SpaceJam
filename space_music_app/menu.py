...
class Menu:
    def __init__(self, screen, sound_manager):
        ...
        self.volume_handle = pygame.Rect(300 + (200 * self.volume) - 10, 295, 20, 30)
    ...
    def draw_settings(self):
        ...
        pygame.draw.rect(self.screen, (150, 150, 255), 
                        (self.volume_rect.x, self.volume_rect.y, 
                         self.volume_rect.width * self.volume, self.volume_rect.height))
        pygame.draw.rect(self.screen, (200, 200, 255), self.volume_handle)
        
        # Draw volume label
        volume_label = self.subtitle_font.render(f"Volume: {int(self.volume * 100)}%", 
                                               True, (255, 255, 255))
    ...
    def handle_settings(self, event):
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            x = max(self.volume_rect.left, min(event.pos[0], self.volume_rect.right))
